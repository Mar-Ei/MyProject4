...
namespace BackendApi.Migrations
{
    ...
    partial class med : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackendApi.Models.NotificationStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BackendApi.Models.ReportType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BackendApi.Models.Subject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BackendApi.Models.SubjectInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BackendApi.Models.TaskAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BackendApi.Models.TaskCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BackendApi.Models.TaskComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BackendApi.Models.TaskDescription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BackendApi.Models.TaskPriority", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BackendApi.Models.TaskStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BackendApi.Models.TaskStatusHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BackendApi.Models.TaskType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BackendApi.Models.UserInfo", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("BackendApi.Models.Notification", b =>
                {
                    b.HasOne("BackendApi.Models.NotificationStatus", "Status")
                        .WithMany("Notifications")
                        .HasForeignKey("StatusId")
                        .IsRequired()
                        .HasConstraintName("FK__Notificat__statu__4D94879B");

                    b.HasOne("BackendApi.Models.Task", "Task")
                        .WithMany("Notifications")
            ...
            modelBuilder.Entity("BackendApi.Models.Report", b =>
                {
                    b.HasOne("BackendApi.Models.ReportType", "ReportType")
                        .WithMany("Reports")
            ...
            modelBuilder.Entity("BackendApi.Models.SubjectInfo", b =>
                {
                    b.HasOne("BackendApi.Models.Subject", "Subject")
                    ...
                    b.HasOne("BackendApi.Models.Teacher", "Teacher")
                        .WithMany("SubjectInfos")
            ...
            modelBuilder.Entity("BackendApi.Models.Task", b =>
                {
                    b.HasOne("BackendApi.Models.TaskCategory", "Category")
                        .WithMany("Tasks")
                        .HasForeignKey("CategoryId")
                        .IsRequired()
                        .HasConstraintName("FK__Tasks__categoryI__37A5467C");

                    b.HasOne("BackendApi.Models.TaskPriority", "Priority")
                        .WithMany("Tasks")
                        .HasForeignKey("PriorityId")
                        .IsRequired()
                        .HasConstraintName("FK__Tasks__priorityI__35BCFE0A");

                    b.HasOne("BackendApi.Models.TaskStatus", "Status")
                        .WithMany("Tasks")
                        .HasForeignKey("StatusId")
                        .IsRequired()
                        .HasConstraintName("FK__Tasks__statusId__36B12243");

                    b.HasOne("BackendApi.Models.TaskType", "Type")
                        .WithMany("Tasks")
            ...
            modelBuilder.Entity("BackendApi.Models.TaskStatusHistory", b =>
                {
                    b.HasOne("BackendApi.Models.TaskStatus", "NewStatus")
                        .WithMany("TaskStatusHistoryNewStatuses")
                        .HasForeignKey("NewStatusId")
                        .IsRequired()
                        .HasConstraintName("FK__TaskStatu__newSt__440B1D61");

                    b.HasOne("BackendApi.Models.TaskStatus", "OldStatus")
            ...
            modelBuilder.Entity("BackendApi.Models.UserInfo", b =>
                {
                    b.HasOne("BackendApi.Models.User", "IdNavigation")
                        .WithOne("UserInfo")
                        .HasForeignKey("BackendApi.Models.UserInfo", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("UserRole", b =>
                {
                    b.HasOne("BackendApi.Models.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BackendApif.Models.User", b =>
                {
                    b.Navigation("Reports");
